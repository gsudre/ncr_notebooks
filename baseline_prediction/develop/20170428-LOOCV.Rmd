...
Now, say we do a LOOCV. How well do we predict the left out subject?

```{r}
preds = c()
for (s in 1:10) { #length(y)) {
  ...
  preds = rbind(preds, predict(model_list[[1]], newdata=filtXtest, type='prob'))
}
```
