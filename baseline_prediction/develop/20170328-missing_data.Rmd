...
CAN WE DO A BETTER JOB OF TUNING THE ADA CLASSIFIER (CLEAN OR NON CLEAN)? maybe RFE?
IF ALL WORKS:
  FIGURE OUT BEST FEATURES
  RUN CLASSIFIER PER DOMAIN
  RUN SCRIPTS WITH DIFFERENT SEEDS AND FARM IT OUT SO WE CAN HAVE A NICE DISTRIBUTION OF TEST SET RESULTS
