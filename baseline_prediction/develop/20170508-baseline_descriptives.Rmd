...
write.csv(cbind(t(res), t(res2), t(res3), t(res4)), file='~/data/baseline_prediction/descriptives/prs.csv')
```
...
write.csv(cbind(t(res), t(res2)), file='~/data/baseline_prediction/descriptives/lobar_volume.csv')
