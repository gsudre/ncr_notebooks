...
lobar_regions = unique(regional$lobar)[1:8]
...
res = sapply(as.data.frame(volumeLobar_data), outcomePairwise_test, merged)
write.csv(t(res), file='~/data/baseline_prediction/descriptives/dw_lobar_volume.csv')
```