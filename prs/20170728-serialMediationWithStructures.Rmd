...
pvals = sapply(Ys, function(s) summary(lm(as.formula(sprintf('%s ~ AGE + Sex + MPRAGE_QC', s)), data=mydata))$coefficients['MPRAGE_QC',4])
...
pvals = sapply(Ys, function(s) summary(lm(as.formula(sprintf('%s ~ AGE + Sex + avg_freesurfer_score', s)),
