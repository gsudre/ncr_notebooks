...
# loading mediator
pheno = read.csv('~/data/prs/resting_08112017.csv')

out_fname = '~/data/prs/results/model4_p3_rsfmri_DX.csv'

mydata = merge(df, pheno, by.x='MRN', by.y='Medical.Record...MRN...Subjects')
