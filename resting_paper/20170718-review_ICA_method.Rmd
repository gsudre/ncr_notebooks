...
abline(h=.05, lty=3)
abline(v=.85, lty=3)
cor.test(1-pvals, fmri_iqs, method='spearman')
cor.test(1-pvals_adhdOnly, fmri_iqs, method='spearman')
...
abline(h=.05, lty=3)
abline(v=.85, lty=3)
cor.test(1-pvals, meg_iqs, method='spearman')
cor.test(1-pvals_adhdOnly, meg_iqs, method='spearman')
```
